...
public class TwitterReviewProcessTest {
    ...
    private static final String TEST_EMAIL = "michereb@students.zhaw.ch";
    private static final String TEST_ALIAS = "mich";
    private static final String TEST_TWEET_CONTENT = "Was für ein weltklasse Tweet";
